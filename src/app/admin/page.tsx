...
function AdminAllBookingsContent({
  ...
  // Extract params from URL promise
  ...
  // React Query: Fetch admin-wide bookings list
    ...
    <div className="space-y-6 flex-1 flex flex-col">
      ...
      {isLoading ? (
        ...
        <div className="rounded-xl border border-rose-200 bg-rose-50 p-8 text-center max-w-xl mx-auto">
          ...
          <p className="mt-2 text-sm text-rose-600">{(error as Error)?.message || 'Check your Admin Token or database connectivity.'}</p>
        ...
        <div className="text-center py-20 text-slate-500 border border-dashed rounded-xl bg-white">
          ...
          <p className="text-sm text-slate-500 mt-1">No database records matched your search parameters.</p>
        </div>
      ) : (
...
export default function AdminAllBookingsPage({
  ...
  return (
    <Suspense fallback={<div className="py-12 text-center text-slate-500">Initializing admin overview table...</div>}>
